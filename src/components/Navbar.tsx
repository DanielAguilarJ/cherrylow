  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-ink/95 light:bg-white/95 backdrop-blur-xl border-b border-cherry/10 shadow-lg shadow-black/20 light:shadow-gray-900/10"
          : "bg-gradient-to-b from-ink/50 light:from-white/70 to-transparent"
      }`}
    >
          ...
          <div className="hidden md:flex items-center gap-1">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="relative px-4 py-2 text-sm font-medium text-smoke/70 light:text-ink/70 hover:text-white light:hover:text-ink transition-colors duration-300 uppercase tracking-widest group rounded-lg hover:bg-white/5 light:hover:bg-ink/8"
              >
                {link.name}
            ...
            <button
              ...
              className="ml-2 w-9 h-9 flex items-center justify-center rounded-full border border-white/10 light:border-ink/15 text-smoke/70 light:text-ink/70 hover:text-cherry light:hover:text-cherry hover:border-cherry/30 transition-all duration-300"
            >
              {theme === "dark" ? (
            ...
            <a
              ...
              className="ml-4 inline-flex items-center gap-2 px-6 py-2.5 bg-cherry text-white text-sm font-bold uppercase tracking-wider rounded-full hover:bg-cherry-dark transition-all duration-300 hover:scale-105 glow-cherry"
            >
          ...
          <div className="md:hidden flex items-center gap-2">
            ...
            >
              <motion.span
                ...
                className="block w-7 h-0.5 bg-white light:bg-ink transition-colors"
              />
              <motion.span
